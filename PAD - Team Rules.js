...
*/
    ...
    static function OnBeforeResponse(oSession: Session) {
		...
		if (oSession.url.Contains("api-na-adrv2.padsv.gungho.jp") && oSession.url.Contains("get_player_data")) {
			...
			//1-?, 2-exp, 3-lvl, 4-?, 5-?, 6-id, 8,9,10-egg, 11,12-?
			//	j.JSONObject["mp"] = 1000000;
			FiddlerApplication.Log.LogString(j.JSONObject["friends"].Count.ToString());
			
			//aizen
			
			var lead = 3359;
			var sub1 = 2076;
			var sub2 = 1644; //default
			//var sub2 = 2512; //red + green
			//var sub2 = 2226; //dmg ignore def
			...
			*/
			...
			var friend = 2969;
			*/
			for (var i = 0; i < j.JSONObject["friends"].Count; i++) {
			
			
				j.JSONObject["friends"][i][13] = 99;
				j.JSONObject["friends"][i][14] = 99;
				j.JSONObject["friends"][i][15] = 99;
				j.JSONObject["friends"][i][16] = friend;
				j.JSONObject["friends"][i][17] = 99;
				j.JSONObject["friends"][i][18] = 99;
				j.JSONObject["friends"][i][19] = 99;
				j.JSONObject["friends"][i][20] = 99;
				j.JSONObject["friends"][i][21] = 99;
				j.JSONObject["friends"][i][22] = 99;
				
				
				j.JSONObject["friends"][i][23] = 99;
				j.JSONObject["friends"][i][24] = 99;
				j.JSONObject["friends"][i][25] = 99;
				j.JSONObject["friends"][i][26] = friend;
				
				j.JSONObject["friends"][i][27] = 99;
				j.JSONObject["friends"][i][28] = 99;
				j.JSONObject["friends"][i][29] = 99;
				j.JSONObject["friends"][i][31] = 99;
				j.JSONObject["friends"][i][32] = 99;
				j.JSONObject["friends"][i][33] = 99;
				j.JSONObject["friends"][i][34] = 99;
				j.JSONObject["friends"][i][35] = 99;
			}
			
			j.JSONObject["card"][0][5] = lead;
			j.JSONObject["card"][0][2] = 99;
			j.JSONObject["card"][0][3] = 99;
			j.JSONObject["card"][0][6] = 99;
			j.JSONObject["card"][0][7] = 99;
			j.JSONObject["card"][0][8] = 99;
			j.JSONObject["card"][0][9] = 99;
			
			j.JSONObject["card"][1][5] = sub1;
			j.JSONObject["card"][1][2] = 99;
			j.JSONObject["card"][1][3] = 99;
			j.JSONObject["card"][1][6] = 99;
			j.JSONObject["card"][1][7] = 99;
			j.JSONObject["card"][1][8] = 99;
			j.JSONObject["card"][1][9] = 99;
			
			j.JSONObject["card"][2][5] = sub2;
			j.JSONObject["card"][2][2] = 99;
			j.JSONObject["card"][2][3] = 99;
			j.JSONObject["card"][2][6] = 99;
			j.JSONObject["card"][2][7] = 99;
			j.JSONObject["card"][2][8] = 99;
			j.JSONObject["card"][2][9] = 99;
			
			j.JSONObject["card"][4][5] = sub3;
			j.JSONObject["card"][4][2] = 99;
			j.JSONObject["card"][4][3] = 99;
			j.JSONObject["card"][4][6] = 99;
			j.JSONObject["card"][4][7] = 99;
			j.JSONObject["card"][4][8] = 99;
			j.JSONObject["card"][4][9] = 99;
			
            
			j.JSONObject["cost"] = "1000";
			j.JSONObject["card"][3][5] = sub4;
			j.JSONObject["card"][3][2] = 99;
			j.JSONObject["card"][3][3] = 99;
			j.JSONObject["card"][3][6] = 99;
			j.JSONObject["card"][3][7] = 99;
			j.JSONObject["card"][3][8] = 99;
			j.JSONObject["card"][3][9] = 99;
			//FiddlerApplication.Log.LogString(j.JSONObject["cost"]);
			//FiddlerApplication.Log.LogString(j.JSONObject[0]["cost"].ToString());
            
			for (var i = 5; i < 150; i++) {
				//ill txt if aj.JSONObject["card"][i][5] = i + 1495;
			}
